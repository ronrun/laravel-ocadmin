<form id="form-list" method="post" data-oc-toggle="ajax" data-oc-load="{{ route('lang.admin.post.categories.list') }}" data-oc-target="#category">
	@csrf
	@method('POST')
	...
	{!! $records->links('ocadmin.common.pagination', ['categories' => $records]) !!}
</form>
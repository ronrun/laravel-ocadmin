            ...
            <div id="tab-general" class="tab-pane active show" role="tabpanel">
              <fieldset>
                ...
                <div class="row mb-3 required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="name" value="{{ $tag->name }}" id="input-name" class="form-control">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="input-description" name="description" value="{{ $tag->description }}" class="form-control">

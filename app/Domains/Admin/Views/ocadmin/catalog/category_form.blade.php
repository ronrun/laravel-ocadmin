        ...
        <form id="form-category" action="{{ $save }}" method="post" data-oc-toggle="ajax">
          ...
          <div class="tab-content">
            <div id="tab-general" class="tab-pane active show" role="tabpanel">
              ...
              <div class="tab-content">
                @foreach($supportedLocales as $locale => $localeContent)
                  <input type="hidden" name="category_translations[{{ $locale }}][id]" value="{{ !empty($category_translations->$locale) ? $category_translations->$locale->id : '' }}" >
                  ...
                  <div id="language-{{ $locale }}" class="tab-pane @if($loop->first) active @endif">
                    <div class="row mb-3 required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="input-name-{{ $locale }}" name="category_translations[{{ $locale }}][name]" value="{{ !empty($category_translations->$locale) ? $category_translations->$locale->name : '' }}" class="form-control">
                    ...
                    <div class="row mb-3 required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="input-slug-{{ $locale }}" name="category_translations[{{ $locale }}][slug]" value="{{ !empty($category_translations->$locale) ? $category_translations->$locale->slug : '' }}" class="form-control">

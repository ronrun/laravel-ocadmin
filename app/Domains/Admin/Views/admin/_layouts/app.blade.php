...
<head>
  ...
  <base href="http://dboemlaravel.test/admin/"/>
...
<div id="container">
  ...
  <header id="header" class="navbar navbar-expand navbar-light bg-light">
    <div class="container-fluid">
      <a href="http://dboemlaravel.test/admin/index.php?route=common/dashboard&amp;user_token=4c90b9e922ee3c23f21f07d551dc9d15" class="navbar-brand d-none d-lg-block"><img src="/assets-admin/ocadmin/view4024/image/logo.png" alt="OpenCart" title="OpenCart"/></a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li id="nav-language" class="nav-item dropdown">      <a href="en-gb" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><img src="http://dboemlaravel.test/catalog/language/en-gb/en-gb.png" alt="English" title="English"/></a>
  <ul class="dropdown-menu">
      <li><a href="en-gb" class="dropdown-item"><img src="http://dboemlaravel.test/catalog/language/en-gb/en-gb.png" alt="English" title="English"/> English</a></li>
  </ul>
...
//--></script></li>
          <li id="nav-profile" class="nav-item dropdown">
            <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle"><img src="{{ asset('/assets-admin/ocadmin/view4024/image/profile.png') }}" alt="John Doe" title="John Doe" class="rounded-circle"/><span class="d-none d-md-inline d-lg-inline">&nbsp;&nbsp;&nbsp;John Doe <i class="fa-solid fa-caret-down fa-fw"></i></span></a>
          ...
          <li id="nav-logout" class="nav-item">
            ...
            <form id="logout-form" action="{{ route('lang.logout') }}" method="POST" class="d-none">@csrf</form>
          </li>
        </ul>
          </div>
  </header>

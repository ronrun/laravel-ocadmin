...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="float-end">
        <button type="submit" form="form-term" data-bs-toggle="tooltip" title="{{ $lang->save }}" class="btn btn-primary"><i class="fa fa-save"></i></button>
              ...
              <div id="tab-data" class="tab-pane active">
                  ...
                  <fieldset>
                    ...
                    <div class="row mb-3 required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" id="input-code" name="code" value="{{ $term->code }}" class="form-control"/>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $term->updated_at }}" class="form-control" disabled/>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <input type="text" value="{{ $term->created_at }}" class="form-control" disabled/>
                      </div>
                    </div>
                                  </fieldset>

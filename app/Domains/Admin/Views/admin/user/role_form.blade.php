                      ...
                      <div class="col-sm-10">
                        @foreach($languages as $language)
                          <div class="input-group">
                            ...
                            <input type="text" id="input-trans_name-{{ $language->locale }}" name="translations[{{ $language->locale }}][trans_name]" value="{{ $translations[$language->locale]->trans_name ?? '' }}" class="form-control"/>
                          </div>
                          <div id="error-trans_name-{{ $language->locale }}" class="invalid-feedback"></div>
                        @endforeach
                      </div>
                    </div>

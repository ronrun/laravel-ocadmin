            ...
            <div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <link type="text/css" href="{{ asset('ocadmin-asset/javascript/jquery/jqvmap/jqvmap.css') }}" rel="stylesheet" media="screen"/>
                     <script type="text/javascript" src="{{ asset('ocadmin-asset/javascript/jquery/jqvmap/jquery.vmap.js') }}"></script>
                     <script type="text/javascript" src="{{ asset('ocadmin-asset/javascript/jquery/jqvmap/maps/jquery.vmap.world.js') }}"></script>
                     <script type="text/javascript"><!--
                        $(document).ready(function() {
                            $.ajax({
                                url: 'ocadmin-asset/test/map.php',
                                dataType: 'html',
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                     ...
                     <script type="text/javascript" src="{{ asset('ocadmin-asset/javascript/jquery/flot/jquery.flot.js') }}"></script>
                     <script type="text/javascript" src="{{ asset('ocadmin-asset/javascript/jquery/flot/jquery.flot.resize.min.js') }}"></script>
                     <script type="text/javascript"><!--

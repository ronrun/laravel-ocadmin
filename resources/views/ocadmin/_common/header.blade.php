...
<html dir="ltr" lang="en">
    <head>
        ...
        <base href="http://laraocadmin.test/backend/"/>
        ...
        <div id="container">
            ...
            <header id="header" class="navbar navbar-expand navbar-light bg-light">
                <div class="container-fluid">
                    <a href="{{ route('admin.dashboard') }}" class="navbar-brand d-none d-lg-block"><img src="/oc-asset/image/logo.png" alt="OpenCart" title="OpenCart"/></a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <?php /* <a href="{{ route('logout') }}" class="nav-link"><i class="fas fa-sign-out-alt"></i> <span class="d-none d-md-inline">Logout</span></a> */ ?>
